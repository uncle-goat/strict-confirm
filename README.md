...
5. **Output Accountability** — All verifiable claims must be backed by evidence; numbers must be measured, not estimated; errors must be corrected, not just acknowledged; all statements must be precise and verifiable with no unfounded comparisons or causal claims
...
- AI making unfounded comparative or causal claims without evidence
